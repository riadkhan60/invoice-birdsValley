    ...
    <div className="  px-6 pt-2">
      <form className=" " onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className=" grid gap-x-3 gap-y-5 md:gap-x-6  md:gap-y-8">
          ...
          <label className="form-control w-full max-w-xs">
            <div className="label">
              <span className="label-text  text-slate-300">Item Quantity</span>
          ...
          <label className="form-control w-full max-w-xs">
            <div className="label">
              <span className="label-text text-slate-300"> Product Price</span>
              <span className="label-text text-slate-300">
                <IoPricetagOutline />
              </span>
            </div>
          ...
          <label className="form-control w-full max-w-xs">
            <div className="label">
              <span className="label-text text-slate-300"> Delivery Cost</span>
              <span className="label-text text-slate-300">
                <FaDollarSign />
              </span>
            </div>
